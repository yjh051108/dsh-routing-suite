...
check('meta-tools', src.includes("const META_TOOLS = ['phase_advance', 'dev_router_status', 'tools_catalog', 'tools_help', 'skill']"))
check('skill-always-on', src.includes("'tools_catalog', 'tools_help', 'skill'"))
